                        ...
                        <div className="infos-profil">
                            ...
                            <div className="content-info">
                                <div className="list-content">
                                    ...
                                    <Divider light={true} variant="middle"/>
                                    <input type="text" onChange={this.handleChange} name="Category" className={this.state.editbutton ? "content-item-enabled" : "content-item-disabled"} value={this.state.sector}/>
                                    <Divider light={true} variant="middle"/>
