            ...
            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%'}}>
                ...
                <div style={{marginTop: '100px', flex: '1 1 16%', display: 'flex', flexDirection: 'column'}}>
                    ...
                    <FormControl className={useStyles.formControl}>
                        ...
                        >
                        <MenuItem value="Accounting">Mode</MenuItem>
                        <MenuItem value="ApparelFashion">Informatique</MenuItem>
                        <MenuItem value="ArchitecturePlanning">Beauty</MenuItem>
                        <MenuItem value="ArtCraft">Furniture</MenuItem>
                        <MenuItem value="Automative">Electronic</MenuItem>
                        <MenuItem value="Banking">Sport</MenuItem>
                        </Select>
                    </FormControl>
